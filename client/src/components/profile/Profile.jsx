...
const Profile = () => {
  ...
  const hundleUploadGallery = async (e, currentImage) => {
    ...
    let objIndex = profileGallery.findIndex(
      ...
      {user.name && (
        <div className={styles.profile}>
          <div className={styles.profile__avatar}>
            {edit && (
              <div className={styles.avatar_edit}>
                <input
                  ...
                  id="profileImg"
                  accept=".png, .jpg, .jpeg"
                  onChange={(e) => hundleUploadImage(e, user.profileImg)}
                />
            ...
            <div
              className={
                edit ? styles.avatar_preview_new : styles.avatar_preview
              }
            >
              {user?.profileImg && (
                <img
                  className={
                    edit ? styles.avatar_iamge_edit : styles.avatar_iamge
                  }
          ...
          <div className={styles.profile_name}>
            {!name ? (
              <span className={styles.input_preview}>{user?.name}</span>
            ) : (
              <input
                name="name"
          ...
          <div className={styles.profile_username}>
            {!username ? (
              <span className={styles.input_preview}>@{user?.username}</span>
            ) : (
              <input
                name="username"
                placeholder={user.username}
                className={
                  newUser ? styles.input_edit : styles.input_edit_error
                }
                onChange={handleChangeInput}
                onBlur={() => {
                  checkUsername();
          ...
          <button
            ...
            onClick={() => (edit ? hundleSubmit() : setEdit(true))}
          >
            Edit Profile
          </button>
        </div>
              ...
              {edit && (
                <div className={styles.gallery_edit}>
                  <input
                    ...
                    id={img.image}
                    accept=".png, .jpg, .jpeg"
                    onChange={(e) => hundleUploadGallery(e, img.image)}
                  />
